...
class CustomSegment: UIButton {
    ...
    */
    ...
    @discardableResult public func set(width: CGFloat) -> CustomSegment {
        self.width = width
        return self
    }
    
    @discardableResult public func set(image position: ImagePosition) -> CustomSegment {
        self.imagePosition = position
        return self
    }
    
    @discardableResult public func set(padding: CGFloat) -> CustomSegment {
        self.padding = padding
        return self
    }
    
    @discardableResult public func set(title: String?, for state: UIControl.State = .normal) -> CustomSegment {
        super.setTitle(title, for: state)
        return self
    }
    
    @discardableResult public func set(titleColor: UIColor?, for state: UIControl.State = .normal) -> CustomSegment {
        super.setTitleColor(titleColor, for: state)
        return self
    }
    
    @discardableResult public func set(image: UIImage?, for state: UIControl.State = .normal) -> CustomSegment {
        super.setImage(image, for: state)
        return self
    }
    
    @discardableResult public func set(background image: UIImage?, for state: UIControl.State = .normal) -> CustomSegment {
        super.setBackgroundImage(image, for: state)
        return self
    }
    
    @discardableResult public func set(attributedTitle: NSAttributedString?, for state: UIControl.State = .normal) -> CustomSegment {
